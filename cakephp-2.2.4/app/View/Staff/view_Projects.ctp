...
<tr>
 ...
 <tr>
    <td><?php echo $this->HTML->link($Projects['Project']['project_name'], array('controller' => 'Staff', 'action' => 'viewProject', $Projects['Project']['project_id']));?></td>
    ...
    <td><?php echo $this->HTML->link('Flag Interest', array('controller' => 'Staff', 'action' => 'flag', $Projects['Project']['project_id']));?></td>
 </tr>
<?php endforeach; ?>
<?php unset($Projects); ?>
</table>