...
<p> Select which of your projects assign to. </p>
...
<tr>
 ...
 <tr>
    ...
    <td><?php echo $ownedprojects['Project']['project_owner_id'];?></td>
    <td><?php echo $this->HTML->link('Select', array('controller' => 'ProjectAllocations', 'action' => 'allocate', $ownedprojects['Project']['project_id'],$staffid));?></td>
 </tr>
<?php endforeach; ?>
